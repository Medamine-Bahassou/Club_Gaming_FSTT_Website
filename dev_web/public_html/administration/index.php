<?php
  ...
  $query->execute();
  $admin_count = $query->fetchColumn();

  $query = $conn->prepare("SELECT COUNT(*) FROM user");
  $query->execute();
  $user_count = $query->fetchColumn();
