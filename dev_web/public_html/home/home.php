        ...
        <div class="blur">
          ...
          <div id="About" class="section-about w-100" style="min-height: 100vh;" >
            <div class="container">
              ...
              <div class="row">
                <!-- txt -->
                <div class="col-md-6 d-flex justify-content-center align-items-center h-100 mt-5 mb-5">
                  <div class="card bg-transparent mx-5 rounded-5 border border-light d-flex justify-content-center align-items-center">
                    <div class="card-body d-inline-block ">
                      ...
                      <p class="card-text text text-white"> L'AFSTEJ est dirigée par une équipe d'étudiants bénévoles élus par leurs pairs. 
                    ...
                    <a href="#" class="button-87 mb-4 w-75 rounded-pill" style="bottom: 0;">Show more</a>
